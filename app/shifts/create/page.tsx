...
// ========== リアルな時間帯別パターン（60席の飲食店） ==========
// 曜日別の基本客数パターン（1時間あたりの来店客数）
// 60席 × 回転率でピーク時は満席近くになる想定
const WEEKDAY_CUSTOMER_PATTERN: Record<number, number> = {
  11: 12, 12: 35, 13: 28, 14: 10, 15: 6,  16: 8,
  17: 15, 18: 32, 19: 42, 20: 35, 21: 20, 22: 8,
}

const FRIDAY_CUSTOMER_PATTERN: Record<number, number> = {
  11: 15, 12: 40, 13: 32, 14: 12, 15: 8,  16: 10,
  17: 20, 18: 38, 19: 44, 20: 42, 21: 28, 22: 12,
}

const WEEKEND_CUSTOMER_PATTERN: Record<number, number> = {
  11: 22, 12: 44, 13: 42, 14: 20, 15: 14, 16: 12,
  17: 24, 18: 42, 19: 45, 20: 44, 21: 30, 22: 14,
}

// 時間帯別の客単価（ランチとディナーで大きく異なる）
const AVG_SPEND_BY_HOUR: Record<number, number> = {
  11: 1100, 12: 1250, 13: 1150, 14: 1000, 15: 900, 16: 950,
  17: 2500, 18: 3200, 19: 3500, 20: 3800, 21: 3200, 22: 2800,
}
